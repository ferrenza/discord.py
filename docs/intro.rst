...
This is the documentation for discord_real.py, a library for Python to aid
in creating applications that utilise the Discord API.

Prerequisites
---------------

discord_real.py works with Python 3.8 or higher. Support for earlier versions of Python
...
To get voice support, you should use ``discord_real.py[voice]`` instead of ``discord_real.py``, e.g. ::
...
discord_real.py revolves around the concept of :ref:`events <discord-api-events>`.
